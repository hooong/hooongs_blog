...
> 해당 문제는 KMP 알고리즘을 구현해보는 문제였다. KMP 알고리즘은 [해당 링크](https://hooongs.tistory.com/304)에 따로 정리를 해보았다.
>
> KMP 알고리즘에서 매칭이 성공한 경우 count를 하고 매칭 성공이 시작되는 인덱스들을 리스트에 저장하고 마지막에 출력을 해주면 되는 문제였다.
